...
SFAsset::SFAsset(SFASSETTYPE type) {
  ...
  switch (type) {
  case SFASSET_PLAYER:
    tmp_surf = IMG_Load("assets/ship.bmp"/*"assets/ship.png"*/);
    break;
  case SFASSET_PROJECTILE:
    tmp_surf = IMG_Load("assets/shot.png");
    break;
  case SFASSET_ALIEN:
    tmp_surf = IMG_Load("assets/invaders.png");
    break;
  case SFASSET_COIN:
    tmp_surf = IMG_Load("assets/nade.png");
    break;
  case SFASSET_HOUSE:
...
void SFAsset::GoWestSlow() {
if(checkWest == false){
	  Vector2 c = *(bbox->centre) + Vector2(-0.5f, 0.0f);
...
/////////////////////////////////////////////////////////////////////////////////////
// For speeding up the projecticle////////////////////////////////////////////////////

void SFAsset::GoNorthFast() {
...
////////////////////////////////////////////////////////////////////
//Vector for moving the aliens slowly down the screen
...
///////////////////////////////////////////////////////////////////
////I added this in for the powerups to travel south instead of the preset north
...
////////////////////////////Added SFASSET_COIN to destroy the grenades on the screen and add to the score.
void SFAsset::HandleCollision() {
  if(SFASSET_PROJECTILE == type || SFASSET_ALIEN == type || SFASSET_PROJECTILE == type || SFASSET_COIN == type || SFASSET_HOUSE == type) {
    SetNotAlive();
  }
}
