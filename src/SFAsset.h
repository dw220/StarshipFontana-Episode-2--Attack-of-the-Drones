 ...
 */
enum SFASSETTYPE {SFASSET_DEAD, SFASSET_PLAYER, SFASSET_PROJECTILE, SFASSET_ALIEN, SFASSET_COIN, SFASSET_HOUSE};
...
public:
  ...
  virtual void      GoEast();
  virtual void      GoWest();
  virtual void      GoWestSlow();
  virtual void      GoEastSlow();
  virtual void      GoEastFast();
  virtual void      GoWestFast();
  virtual void      GoNorth();
  virtual void      GoNorthFast();
  virtual void      GoSouth();
  virtual void      GoSouthFast();
